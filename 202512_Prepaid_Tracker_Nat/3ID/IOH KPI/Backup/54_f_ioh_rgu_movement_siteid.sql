...
FROM `data-bi-prd-935c.bi_mart.h3i_project_ioh_kpi_daily_tracker_site` a
...
delete from `data-bi-prd-935c.bi_mart.h3i_project_ioh_kpi_daily_tracker_site` where load_dt_sk_id = vdt_id and kpi_code in
...
delete from `data-bi-prd-935c.bi_mart.h3i_project_ioh_kpi_daily_tracker_site` where load_dt_sk_id = vdt_id and kpi_code = 'M2S_MTD';
...
delete from `data-bi-prd-935c.bi_mart.h3i_project_ioh_kpi_daily_tracker_site` where load_dt_sk_id = vdt_id and kpi_code = 'GA_M2S_MTD';
...
FROM (
    SELECT DISTINCT sbscrptn_ek_id, site_id
    FROM `data-bi-prd-935c.bi_mart.fct_ga_site_id`
    WHERE SUBSTR(CAST(dt AS STRING), 1, 6) = FORMAT_DATE('%Y%m', DATE_TRUNC(DATE_SUB(CAST(vdt_id AS DATE), INTERVAL 2 MONTH), MONTH))
) a
GROUP BY load_dt_sk_id, entity, kpi_code, definition, dt, site_id, remark, created_dtm;

delete from `data-bi-prd-935c.bi_mart.h3i_project_ioh_kpi_daily_tracker_site` where load_Dt_sk_id = vdt_id and kpi_code in ('s_addr_qsso_lt3', 's_addr_qsso_0');
...
delete from `data-bi-prd-935c.bi_mart.h3i_project_ioh_kpi_daily_tracker_site` where load_dt_sk_id = vdt_id and kpi_code = 'FU_MTD';
...
LEFT JOIN (
   ...
   AND LEAST(CAST(first_usage_dt AS DATE),
             LEAST(PARSE_DATE('%Y%m%d', CAST(first_billing_usage_dt_sk_id AS STRING)), CAST(any_event_first_usage_date AS DATE))) = b.dt
WHERE LEAST(CAST(first_usage_dt AS DATE),LEAST(PARSE_DATE('%Y%m%d', CAST(first_billing_usage_dt_sk_id AS STRING)), CAST(any_event_first_usage_date AS DATE))) >= DATE_TRUNC(vdt_id, MONTH)
AND LEAST(CAST(first_usage_dt AS DATE),LEAST(PARSE_DATE('%Y%m%d', CAST(first_billing_usage_dt_sk_id AS STRING)), CAST(any_event_first_usage_date AS DATE))) <= vdt_id
...
delete from`data-bi-prd-935c.bi_mart.h3i_project_ioh_kpi_daily_tracker_site` where load_dt_sk_id = vdt_id and kpi_code = 'HV_FU_MTD';
...
LEFT JOIN (
   ...
   AND LEAST(CAST(first_usage_dt AS DATE),LEAST(PARSE_DATE('%Y%m%d', CAST(first_billing_usage_dt_sk_id AS STRING)), CAST(any_event_first_usage_date AS DATE))) = b.dt
...
delete from `data-bi-prd-935c.bi_mart.h3i_project_ioh_kpi_daily_tracker_site` where load_dt_sk_id = vdt_id and kpi_code = 'HV_FU_MTD_LIST';
...
delete from `data-bi-prd-935c.bi_mart.h3i_project_ioh_kpi_daily_tracker_site` where load_dt_sk_id = vdt_id and kpi_code = 'DSF_M2S_MTD_RATE';
...
delete from `data-bi-prd-935c.bi_mart.h3i_project_ioh_kpi_daily_tracker_site` where load_dt_sk_id = vdt_id and kpi_code = 'DSF_M2S_MTD';
...
delete from `data-bi-prd-935c.bi_mart.h3i_project_ioh_kpi_daily_tracker_site` where load_dt_sk_id = vdt_id and kpi_code = 'DSF_GA_M2S_MTD';
...
delete from `data-bi-prd-935c.bi_mart.h3i_project_ioh_kpi_daily_tracker_site` where load_dt_sk_id = vdt_id and kpi_code = 'M1S_MTD';
...
delete from `data-bi-prd-935c.bi_mart.h3i_project_ioh_kpi_daily_tracker_site` where load_dt_sk_id = vdt_id and kpi_code = 'GA_M1S_MTD';
