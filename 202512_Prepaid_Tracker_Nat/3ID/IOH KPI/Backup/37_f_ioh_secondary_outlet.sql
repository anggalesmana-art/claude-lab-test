...
INSERT INTO `data-bi-prd-935c.bi_mart.project_ioh_secondary_outlet`
				select cast(snp_dt_sk_id as date) dt_sk_id, fct.partner_type, kpi_name, msisdn, cast(angie_hrchy_sk_id as string) as angie_hrchy_sk_id, partner_qr_cd, 'SALDO' secondary_category, kpi_name secondary_type, hierarchy_type, value, kpi_cnt
