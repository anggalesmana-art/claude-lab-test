...
drop table if exists `data-bi-prd-935c.bi_mart.dm_usage_band_90`;
																	   
	  create table `data-bi-prd-935c.bi_mart.dm_usage_band_90`
			as
			...
			from (
				...
				and dt_sk_id >= DATE_SUB(vdt_id, INTERVAL 89 DAY)
