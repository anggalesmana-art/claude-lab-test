...
drop table if exists `data-bi-prd-935c.bi_mart.dm_vlr_band_30`;

create table `data-bi-prd-935c.bi_mart.dm_vlr_band_30`
as
select *
...
and load_dt >= DATE_SUB(vdt_id, INTERVAL 29 DAY)
