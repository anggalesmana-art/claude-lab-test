DECLARE vdt_id DATE DEFAULT @vdt_id;
 	...
 	drop table if exists `data-bi-prd-935c.bi_mart.dm_ggsn_band_90`;


	create table `data-bi-prd-935c.bi_mart.dm_ggsn_band_90`
	as
	select *
	...
	and a.dt_sk_id >= DATE_SUB(vdt_id, INTERVAL 89 DAY)
