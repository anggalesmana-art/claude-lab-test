...
create or replace table `data-bi-prd-935c.bi_mart`.tmp_rgu_vori_{{ vdt_id }}  as
...
where 
prc_dt = timestamp(vdt_id + interval 1 day)
and parse_date('%Y%m%d',transactiondate) = vdt_id
