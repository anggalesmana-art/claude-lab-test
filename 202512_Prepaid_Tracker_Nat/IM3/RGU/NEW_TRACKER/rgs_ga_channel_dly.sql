...
--- Dly
delete from `data-bi-prd-935c.bi_mart.rgs_ga_channel_dly_smy` where dt_id BETWEEN date_trunc(vdt_id,month) AND vdt_id;
INSERT into `data-bi-prd-935c.bi_mart.rgs_ga_channel_dly_smy`
...
END flag_inject, count(1) subs,
timestamp(current_datetime('+7')) ppn_dttm, dt_id
