insert into `data-nationalslsdist-prd-986g`.postpaid.tmp_daily_ga
with ga_bi as (
	select
		a.msisdn,
		b.activation_date,
...
update `data-nationalslsdist-prd-986g`.postpaid.tmp_daily_ga as a 
...
from (
	...
	from ps_trx as a 
		...
		inner join `data-nationalslsdist-prd-986g`.postpaid.tmp_daily_ga as d
...
from (
					select 
						...
						b.full_name,
						b.user_name
						from `data-nationalslsdist-prd-986g`.postpaid.tmp_daily_ga as a
						inner join  (
											select * from (
