...
, ga_contract as(
	select  
        ...
        count(distinct 
        			case when a.order_type in ('New Registration','Migration', 'Port In Migration') and upper(b.channel_group) like '%PARTNER%STORE' and a.tenure=1 then null
        				-- when a.order_type in ('New Registration','Migration', 'Port In Migration') and upper(b.channel_group) like '%DIRECT%SALES' and a.tenure=1 then null
        ...
        sum(case when a.order_type in ('New Registration','Migration', 'Port In Migration') and upper(b.channel_group) like '%PARTNER%STORE' and a.tenure=1 then 0
        				-- when a.order_type in ('New Registration','Migration', 'Port In Migration') and upper(b.channel_group) like '%DIRECT%SALES' and a.tenure=1 then 0
    ...
    left join rce_mapping as b
        ...
        where 1=1 
        	...
        	-- and a.order_type in ('New Registration','Migration', 'Port In Migration') 
...
, ga_monthly as (
    ...
    left join rce_mapping as b
        ...
        where 1=1 
			...
			and cast(a.activation_date as int64)<=20250930
